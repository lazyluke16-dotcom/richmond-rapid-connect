...
import heroImgAvif from "@/assets/hero-plumber.avif";
import heroImg from "@/assets/hero-plumber.jpg";
import heroImgWebp from "@/assets/hero-plumber.webp";
import heroImgMobileAvif from "@/assets/hero-plumber-mobile.avif";
import heroImgMobile from "@/assets/hero-plumber-mobile.jpg";
import heroImgMobileWebp from "@/assets/hero-plumber-mobile.webp";
import {
  Phone,
  Clock,
  MapPin,
    ...
    <AppShell>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <picture className="block h-full w-full">
            <source media="(max-width: 767px)" srcSet={heroImgMobileAvif} type="image/avif" />
            <source media="(max-width: 767px)" srcSet={heroImgMobileWebp} type="image/webp" />
            <source media="(max-width: 767px)" srcSet={heroImgMobile} type="image/jpeg" />
            <source srcSet={heroImgAvif} type="image/avif" />
            <source srcSet={heroImgWebp} type="image/webp" />
            <img
              src={heroImg}
              alt="Local Melbourne plumber repairing pipework beneath a kitchen sink"
              width={1600}
              height={900}
              fetchPriority="high"
              decoding="async"
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, rgba(15,20,35,0.7) 0%, rgba(15,20,35,0.95) 100%)",
            }}
          />
        </div>
        <div className="relative mx-auto max-w-5xl px-4 pt-10 pb-16 sm:pt-16 sm:pb-24">
          <span className="inline-flex items-center gap-2 rounded-full border border-primary/40 bg-primary/10 px-3 py-1 text-xs font-bold uppercase tracking-widest text-primary">
            <span className="inline-block h-2 w-2 rounded-full bg-primary animate-pulse" /> On the
            tools right now
          </span>
          <p className="mt-4 text-2xl font-black uppercase tracking-wider text-primary animate-pulse sm:text-4xl">
            We missed your call!!
          </p>
          ...
          <p className="mt-4 max-w-xl text-base text-muted-foreground sm:text-lg">
            Local Melbourne plumbers covering Richmond, Cremorne, South Yarra, Hawthorn, Abbotsford
            and Prahran. Fair pricing, no BS, licensed and insured.
          </p>
      ...
      <section className="mx-auto max-w-5xl px-4 py-12">
        ...
        <p className="mt-1 text-muted-foreground">
          Tap the closest one — we'll ask a couple of quick questions.
        </p>
      ...
      <section className="border-y border-border bg-card/40">
        <div className="mx-auto max-w-5xl px-4 py-12">
          ...
          <p className="mt-1 max-w-2xl text-muted-foreground">
            When we're on the tools, we can't always answer. Our AI asks the same questions we would
            — so the plumber can assess the job before calling you back.
          </p>
            ...
            {[
              {
                n: "1",
                t: "Tell us the job",
                d: "Pick the issue, suburb, urgency and property type.",
              },
              {
                n: "2",
                t: "Chat a few details",
                d: "The AI asks smart follow-ups and lets you attach photos.",
              },
              {
                n: "3",
                t: "We call you back",
                d: "The plumber sees your summary and rings when free.",
              },
            ].map((s) => (
              <div key={s.n} className="rounded-lg border border-border bg-card p-5">
                <div className="grid h-9 w-9 place-items-center rounded-full bg-primary font-black text-primary-foreground">
                  {s.n}
                </div>
          ...
          <p className="mt-6 text-xs text-muted-foreground">
            Prices are always confirmed by the plumber — we don't promise exact quotes from the
            chat. It just helps us give you a fast, informed call-back.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-4 py-12">
        <div className="grid gap-8 sm:grid-cols-2">
          <div>
            ...
            <p className="mt-1 text-muted-foreground">
              Same-day service across Richmond, Cremorne, South Yarra, Hawthorn, Abbotsford and
              Prahran.
            </p>
            <Link
              to="/areas"
          ...
          <blockquote className="rounded-lg border border-border bg-card p-5">
            ...
            <p className="mt-2 text-sm">
              "Rang after hours with a burst pipe — the AI thing had all my info sorted, plumber
              called back in 4 minutes and was here in 30. Legends."
            </p>
