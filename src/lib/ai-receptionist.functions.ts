...
// Pure prompt builder lives in a runtime-free module so it can be shared with
// bundled server scripts. Imported for internal use and re-exported to preserve
// existing import paths.
import { buildReceptionistInstructions } from "@/lib/ai-receptionist.instructions";
export { buildReceptionistInstructions };
